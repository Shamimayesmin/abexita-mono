...
// export default Navbar;
   ...
   {/* <div className="text-center px-4">
        <SectionTitle
          heading={
            <>
              Looking for a <span className="text-red-500">business solution for</span>{" "}
              appointments?
            </>
          }
        />
        <p className="text-sm md:text-base text-[#667085] mt-5 max-w-3xl mx-auto">
          Ambel simplifies management by providing tools for scheduling
          appointments, managing bookkeeping, accepting payments, sharing resources with
          customers, sending reminders, and running email marketing campaigns.
        </p>
      </div> */}
