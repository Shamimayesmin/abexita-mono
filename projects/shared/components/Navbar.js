...
import Logo from "../../../projects/shared/components/Reuseable/Logo";
      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center">
          ...
          <div className="relative lg:hidden">
            ...
            <ul
              className={`dropdown-content menu absolute top-full left-0 bg-base-100 mt-1 w-36 p-2 shadow z-50 ${isOpen ? "block" : "hidden"}`}
            >
        ...
        <div className="navbar-end">
          {authLinks?.map((link, index) => (
            <Link
              key={index}
              href={link.href}
              className={`btn ${link.isPrimary ? "bg-[#0089C9]" : "hover:bg-sky-300"} lg:p-3 p-1 rounded-md ${
