...
const FreeTrial = () => {
	return (
		<div className="lg:mt-96 mt-[1400px] lg:px-20 px-2 lg:py-10 py-6">
			<div className="flex lg:flex-row flex-col gap-5 bg-[#F5FFFD] lg:px-20 px-5 lg:py-20 py-14 rounded-lg ">
